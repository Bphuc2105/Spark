...
def supabase_table_to_csv(supabase_url: str, supabase_key: str, table_name: str, output_csv_path: str):
    ...
    try:
        ...
        print(f"Đang kết nối tới Supabase tại URL: {supabase_url[:30]}...") 
...
if __name__ == "__main__":
    ...
    if not SUPABASE_URL or not SUPABASE_KEY:
        ...
        SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZtampiZG5naGdkYW1oY29saXVuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MTc0ODAyNiwiZXhwIjoyMDU3MzI0MDI2fQ.Boqfsg63piR-BE-ilSSqK505C3Cf6QuF21tMH8YhBTk" 
        
        

    TABLE_TO_EXPORT = "stock_data"  
